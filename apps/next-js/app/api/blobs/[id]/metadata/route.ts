...
export async function GET(
  ...
  try {
    ...
    const metadata = {
      ...
      // Embedding data
      embedding: blob.embeddings ? {
        caption: blob.embeddings.caption,
        modelName: blob.embeddings.modelName,
        device: blob.embeddings.device,
        embeddingTime: blob.embeddings.embeddingTime,
        captionTime: blob.embeddings.captionTime,
      } : null,
