          ...
          <div className="flex-1 overflow-y-auto space-y-4">
            ...
            {files.length > 0 && (
              ...
              >
                ...
                {isDragOver && (
                  <div className="border-2 border-dashed border-primary rounded-lg p-8 text-center bg-primary/5 mb-2">
                    <Upload className="h-8 w-8 mx-auto mb-2 text-primary" />
                    <p className="text-sm text-primary font-medium">Drop to add more files</p>
                  </div>
                )}
