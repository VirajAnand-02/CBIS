...
### ✅ Search Pipeline
- ✅ Query optimizer and keyword extraction (Port 8003)  
- ✅ Text CLIP encoder (Port 8000, `/encode/text`)  
- ✅ Search router (Port 8004)  
- ✅ Search across tables/spaces (executor in `search-manager.ts`)  
